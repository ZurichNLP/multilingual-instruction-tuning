...
# Example call:
# bash run_xcsr_inference.sh -d 7 -m resources/models/llama_2_7b_hf_de_merged resources/models/llama_2_7b_hf_ca_merged -t data/xcsr_dev_en_*
