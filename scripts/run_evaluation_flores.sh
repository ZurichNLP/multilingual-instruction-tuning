...
# Example usage:
# bash scripts/run_evaluation_flores.sh 0 resources/outputs/flores/llama_2_7b_hf_ml*
# CUDA_VISIBLE_DEVICES=2 python -m evaluation data/flores_outputs/llama_2_7b_hf_ml1_merged/flores_devtest_en_de-none-flores_en_de_en-s0-k50-p0.9-t0.001-b128.jsonl --lang de --src_key source --tgt_key system --ref_key reference
...
for model_outputs_dir in "${model_outputs_dirs[@]}"; do
    for model_outputs_file in "${model_outputs_dir}"/*".jsonl"; do
        ...
        # run lang assignment
        python assign_langs.py "${model_outputs_file}" --keys "reference" "system"
        ...
        CUDA_VISIBLE_DEVICES="${gpu}" python evaluation.py \
            ...
            --src_key source --tgt_key system --ref_key reference --force --use_cuda
