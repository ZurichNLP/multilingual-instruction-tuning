...
# Example call:
# bash run_xquad_inference.sh -d 7 -m resources/models/llama_2_7b_hf_ml1_merged resources/models/llama_2_7b_hf_ca_merged -t data/xquad_dev_en*
    ...
    for test_set in "${test_sets[@]}"; do
        ...
        #     echo "Prompt language: ${prompt_lang}"
            ...
            CUDA_VISIBLE_DEVICES="${d}" python -m inference "${model}" \
                ...
                --batch_size 128 \
                --seed "${seed}" \
                --output_path "resources/outputs/xquad" \
